            ...
            <motion.div variants={itemVariants} className="glass-effect p-8 rounded-xl mb-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="shrink-0 bg-accent/20 p-3 rounded-full mr-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@asdinfor.ovh" className="text-text-secondary hover:text-accent transition-colors duration-300">
