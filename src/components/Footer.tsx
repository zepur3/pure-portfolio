...
const Footer = () => {
  ...
  return (
    <footer className="bg-background/80 backdrop-blur-sm border-t border-border-light py-8">
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <a href="mailto:contact@asdinfor.ovh" className="text-text-secondary hover:text-accent transition-colors duration-300">contact@asdinfor.ovh</a>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-accent mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-border-light mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-text-secondary text-sm mb-4 md:mb-0">
            © {currentYear} ASD Infor. Tous droits réservés.
          </p>
